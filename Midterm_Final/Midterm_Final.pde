...
float x6 = random(250, 750);
float y6 = random (0, 950);
float x7 = random(250, 750);
float y7= random (0, 950);
float x8 = random(250, 750);
float y8 = random (0, 950);
float x9 = random(250, 750);
float y9 = random (0, 950);
float x10 = random(250, 750);
float y10 = random (0, 950);
void setup(){ 
  size (1000,1000);
...
if (key == 'h' || key == 'H'){
  ...
  ellipse(x4,y4,50,50);
  ellipse(x5,y5,50,50);
  ellipse(x6,y6,50,150);
  ellipse(x7,y7,50,150);
  ellipse(x8,y8,50,150);
  ellipse(x9,y9,50,150);
  ellipse(x10,y10,50,150);
}
  }
